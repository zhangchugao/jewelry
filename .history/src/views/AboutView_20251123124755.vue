<template>
  <div class="about">
    ...
    <div class="lab-image-container">
      <img src="https://via.placeholder.com/1200x400?text=GRA+Gemological+Laboratory" alt="GRA Gemological Laboratory" class="lab-image" />
    </div>
...
.title-decoration:last-child::after {
  right: auto;
  left: -5px;
}
